...
exports.initEntries = function (reqPath, dirPath) {
  ...
  for (let filename of filenames) {
    ...
    entries.push({
      ...
      filename: info.isDirectory() ? filename + '/' : JObject.get(path.resolve(config.public, 'map.json'), filename),
      ...
      link: encodeURI(reqPath + '/' + filename)
    })
  }
